...
namespace Homework4._2
{
    class Order
    {
        ...
        public void OutputToFile(TextWriter textWriter,int i)
        {
            textWriter.WriteLine(i);
            textWriter.WriteLine("Index:" + details.number);
            textWriter.WriteLine("Item:" + details.item );
            textWriter.WriteLine("Costumer:" + details.costumer);
        }
